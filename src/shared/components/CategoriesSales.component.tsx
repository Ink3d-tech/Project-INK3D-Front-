...
export default function CategoriesSales() {
    return (
        <div className='h-44 pt-4  pb-8 pl-4 bg-gray-300 flex gap-4 overflow-x-auto w-full flex-nowrap '>

            <div className='bg-white h-32 w-24 shrink-0  rounded-md shadow-md shadow-black flex flex-col items-center pt-4
